...
import net.lucab.shops.block.custom.*;
import net.lucab.shops.item.custom.ShopItem;
...
import static net.lucab.shops.block.VariantResources.*;
import static net.lucab.shops.block.VariantResources.wood_variant.*;
