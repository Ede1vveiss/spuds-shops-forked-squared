...
import net.lucab.shops.screen.networking.ShopTabSyncPkt;
import net.lucab.shops.screen.networking.ToggleSyncPkt;
...
import static net.lucab.shops.block.entity.AbstractShopEntity.player_ID_Records_Delegate.checkAction;
import static net.lucab.shops.block.entity.ShopInventory.PAYMENT_SLOT;
import static net.lucab.shops.block.entity.ShopInventory.VENDING_SLOT;
