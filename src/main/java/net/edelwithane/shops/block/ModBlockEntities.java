...
import net.edelwithane.shops.block.custom.RugShopBlock;
import net.edelwithane.shops.block.custom.ShelfShopBlock;
import net.edelwithane.shops.block.entity.*;
import net.edelwithane.shops.block.entity.*;
